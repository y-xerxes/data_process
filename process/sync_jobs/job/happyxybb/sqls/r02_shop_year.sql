DROP PROCEDURE IF EXISTS `r02_shop_year`;
CREATE PROCEDURE `r02_shop_year`()
BEGIN
 ...
 set @start_d = (select dim_date_id  from Dim_Date_Day a Inner join 
                   ...
                   on a.date_year_code=b.date_year_code and  a.date_month_code=1 and a.date_day_code=1);
